<template>
  <el-aside class="leftmenu">
    <el-scrollbar class="hiddenX" style="height:100%">
      <el-menu :default-active="$route.path" background-color="transparent" text-color="#333" @open="handleOpen" @close="handleClose" :collapse="isCollapse" unique-opened mode="vertical" router>
...
.leftmenu .el-menu .el-menu-item.is-active{ background-color: $color-background-blue !important; }
